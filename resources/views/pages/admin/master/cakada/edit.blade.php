    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.master.cakada.update', $cakada->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label class="form-label" for="title">No. Urut</label>
                                <input type="number" class="form-control @error('no_urut_paslon') is-invalid @enderror"
                                    ...
                                    value="{{ $cakada->no_urut_paslon }}" />
                                @error('no_urut_paslon')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="title">Nama Calon Kepala Daerah</label>
